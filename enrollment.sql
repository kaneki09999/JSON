...
--
-- Stand-in structure for view `confirm_students`
-- (See below for the actual view)
--
  CREATE TABLE `confirm_students` (
  `student_id` int(11)
